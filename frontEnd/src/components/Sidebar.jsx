...
const Sidebar = () => {
  ...
  return (
    <aside className="h-full w-20 lg:w-72 border-r border-base-300 flex flex-col transition-all duration-200">
      ...
      <div className="overflow-y-auto w-full py-3 space-y-0.5">
        {filteredUsers.map((user) => (
          ...
          >
            <div className="relative mx-auto lg:mx-0">
              <img src={user.profilePic || "/profileImageDefault.png"} alt={user.name} className="size-12 object-cover rounded-full" />
